...
add_headline( '<script type="text/javascript">
		window.onload=function()
			...
			Rounded("div.bTitle","top","#fff","#377BA4","smooth");
			}
	</script>' );
...
<div id="pageFooter">
	...
	<p class="baseline">
		...
		<?php display_param_link( $skin_links ) ?> design by <?php display_param_link( $francois_links ) ?> / <?php display_param_link( $skinfaktory_links ) ?> / <a href="http://www.blog.hemminga.net/">Afwas</a> / <a href="http://www.tilqi.com">tilqicom</a>
